...
function CreateReportContent() {
    ...
    return (
        <div className="animate-fade-in space-y-8 pb-20">
            {/* Header / Command Bar */}
            <header className="sticky top-0 z-40 flex flex-col items-stretch md:flex-row md:items-center justify-between bg-card border border-border p-4 md:p-6 rounded-md shadow-xl backdrop-blur-md bg-opacity-95 gap-4">
                <div className="flex-1 max-w-2xl space-y-3">
                    <div className="flex items-center gap-2 text-muted-foreground">
                        ...
                        <span className="text-[10px] uppercase tracking-[0.2em] font-black text-primary/70 truncate">
                    ...
                    <input
                        ...
                        className="w-full bg-transparent text-xl md:text-3xl font-black uppercase text-foreground placeholder:text-muted-foreground/20 focus:outline-none tracking-tight font-sans selection:bg-primary/30"
                    />
                </div>

                <div className="flex items-center justify-between md:justify-end gap-3 pt-2 md:pt-0 border-t md:border-t-0 border-border/50 md:border-0">
                    <div className="hidden lg:flex flex-col text-right mr-4 border-r border-border pr-4 gap-0.5">
                    ...
                    <div className="flex items-center gap-2 w-full md:w-auto">
                        <button
                            ...
                            disabled={loading}
                            className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-muted hover:bg-border text-foreground px-4 py-2 rounded-md text-[10px] md:text-small font-black uppercase tracking-widest transition-all border border-border disabled:opacity-50"
                        >
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-2 rounded-md text-[10px] md:text-small font-black uppercase tracking-widest transition-all shadow-lg shadow-primary/20 disabled:opacity-50"
                        >
