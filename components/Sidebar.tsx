...
export default function Sidebar() {
    ...
    return (
        <aside className="w-64 h-screen fixed left-0 top-0 bg-background border-r border-border flex flex-col z-50 shadow-[4px_0_24px_rgba(0,0,0,0.2)]">
            {/* Header / Brand */}
            <div className="p-5 border-b border-border flex flex-col items-center gap-4 bg-muted/20 backdrop-blur-sm">
